...
class FeatureController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $this->syncIconImage($request, $feature);
    ...
    private function syncIconImage(Request $request, Feature $feature): void
    {
        ...
        $feature->images()->where('collection', 'icon')->get()->each->forceDelete();
