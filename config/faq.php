...
/*
 * Fallback FAQ items when the database has no published rows (docs/MARKETING.md §5.3).
 * Primary source: `faqs` table via FaqSeeder.
 */
...
return [
    'items' => [
        ...
        [
            ...
            'answer' => 'نعم، يدعم مدى ميزة التحقق بخطوتين لحماية حسابات المستخدمين والوصول المصرح به فقط.',
        ],
        [
