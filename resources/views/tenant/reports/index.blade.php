<x-layouts.app title="التقارير والتصدير">
    <div class="mx-auto max-w-5xl space-y-6">
        <div>
            <h1 class="font-display text-2xl font-bold text-ink-900 dark:text-ink-50">التقارير والتصدير</h1>
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <section class="rounded-2xl border border-mist-200 bg-white p-5 shadow-sm dark:border-ink-600 dark:bg-ink-800">
                <h2 class="font-display text-lg font-semibold text-ink-900 dark:text-ink-50">ملخص الحضور</h2>
                ...
                <form method="GET" action="{{ route('tenant.reports.attendance') }}" class="mt-4 space-y-3">
                    ...
                    <div class="flex gap-2">
                        <button type="submit" name="format" value="csv" class="flex-1 rounded-xl bg-emerald-400 py-2 text-sm font-semibold text-emerald-900 hover:bg-emerald-300">Excel / CSV</button>
            ...
            <section class="rounded-2xl border border-mist-200 bg-white p-5 shadow-sm dark:border-ink-600 dark:bg-ink-800">
                <h2 class="font-display text-lg font-semibold text-ink-900 dark:text-ink-50">طلبات الإجازة</h2>
            ...
            <section class="rounded-2xl border border-mist-200 bg-white p-5 shadow-sm dark:border-ink-600 dark:bg-ink-800">
                <h2 class="font-display text-lg font-semibold text-ink-900 dark:text-ink-50">كشف الموظفين</h2>
            ...
            @can('tenant.audit_logs.view')
                <section class="rounded-2xl border border-mist-200 bg-white p-5 shadow-sm dark:border-ink-600 dark:bg-ink-800">
                    <h2 class="font-display text-lg font-semibold text-ink-900 dark:text-ink-50">سجل النشاط والأمان</h2>
