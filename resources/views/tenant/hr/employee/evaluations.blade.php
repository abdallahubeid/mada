<x-layouts.app title="تقييماتي">
    @if ($employee === null)
        <div class="mx-auto max-w-2xl">
            <div class="rounded-2xl border border-mist-200 bg-white p-8 text-center shadow-sm dark:border-ink-600 dark:bg-ink-800">
                <div class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-400/15 text-mist-400 dark:text-mist-500"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" /></svg></div>
                <h1 class="mt-4 font-display text-2xl font-medium text-ink-900 dark:text-ink-50">تقييماتي</h1>
    ...
    @else
        <div class="mx-auto max-w-4xl space-y-6" x-data>
            <div>
                <h1 class="font-display text-2xl font-medium text-ink-900 dark:text-ink-50">تقييماتي</h1>
                        ...
                        <table class="min-w-full divide-y divide-mist-100 text-sm dark:divide-ink-700">
                            <thead class="bg-mist-50 text-mist-500 dark:bg-ink-900 dark:text-mist-400">
                                <tr>
                                    ...
                                    <th class="px-3 py-2 text-xs font-medium text-mist-500 dark:text-mist-400 text-start">ملاحظات المقيّم</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 text-start">
                                            @if ($evaluation->rating !== null)
                                                <span class="inline-flex items-center gap-1 rounded-md bg-brand-500/15 px-2.5 py-0.5 text-xs font-bold text-brand-700 dark:text-brand-300">
                                        ...
                                        <td class="px-3 py-2 text-mist-600 dark:text-mist-300 text-start">
                                            {{ $evaluation->notes ?: '—' }}
                                        </td>
                                        <td class="px-3 py-2 text-mist-600 dark:text-mist-300 text-start">
                                        ...
                                        <td class="px-3 py-2 text-center">
                                            <span @class([
                                                ...
                                                'bg-brand-500/15 text-brand-700 dark:text-brand-300' => $evaluation->status->value === 'approved',
