            ...
            <div class="relative z-10 flex w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-ink-700 bg-ink-900 shadow-2xl">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 border-t border-ink-700 px-4 py-3">
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button" @click="rotate(-90)" class="rounded-lg border border-ink-600 px-3 py-1.5 text-xs font-semibold text-mist-200 hover:border-brand-500 hover:text-brand-300" title="تدوير يسار">↺</button>
                        <button type="button" @click="rotate(90)" class="rounded-lg border border-ink-600 px-3 py-1.5 text-xs font-semibold text-mist-200 hover:border-brand-500 hover:text-brand-300" title="تدوير يمين">↻</button>
                    </div>
                    <div class="flex items-center gap-2">
