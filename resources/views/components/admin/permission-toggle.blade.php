...
<label class="flex cursor-pointer items-center justify-between gap-3 rounded-xl border border-mist-200 px-3 py-2.5 transition hover:border-emerald-300 dark:border-ink-600 dark:hover:border-emerald-500/40 {{ $disabled ? 'opacity-60' : '' }}">
