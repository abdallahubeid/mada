...
@section('title', 'ميزات الذكاء الاصطناعي')
...
@section('breadcrumbs')
    ...
    <span class="text-ink-700 dark:text-mist-200">ميزات الذكاء الاصطناعي</span>
@endsection
    ...
    <div class="mt-6 overflow-hidden rounded-2xl border border-mist-200 bg-white shadow-sm dark:border-ink-600 dark:bg-ink-800">
        <table class="min-w-full divide-y divide-mist-100 text-sm dark:divide-ink-700">
            ...
            <tbody class="divide-y divide-mist-100 dark:divide-ink-700">
                @forelse ($aiFeatures as $aiFeature)
                    @php
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-mist-500">{{ $aiFeature->icon_key }}</td>
                        <td class="px-4 py-3">
                            <span @class([
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form method="POST" action="{{ route('admin.ai-features.destroy', $aiFeature) }}" onsubmit="return confirm('حذف هذا العنصر؟')">
                                    @csrf
                                    @method('DELETE')
