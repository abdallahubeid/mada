...
@section('breadcrumbs')
    <a href="{{ route('admin.features.index') }}" class="text-mist-500 hover:text-emerald-600">الميزات العامة</a>
    <span class="mx-1.5 text-mist-300">/</span>
    <span class="text-ink-700 dark:text-mist-200">إضافة</span>
@endsection

@section('content')
    <h2 class="font-display text-2xl font-bold text-ink-900 dark:text-ink-50">إضافة ميزة</h2>
