...
@section('breadcrumbs')
    <a href="{{ route('admin.testimonials.index') }}" class="text-mist-500 hover:text-brand-600">آراء العملاء</a>
    <span class="mx-1.5 text-mist-300">/</span>
    <span class="text-ink-700 dark:text-mist-200">إضافة</span>
@endsection

@section('content')
    <h2 class="font-display text-2xl font-medium text-ink-900 dark:text-ink-50">إضافة شهادة</h2>
