...
{{--
    ...
    glass illustration card, emerald digit pill). Self-contained so it still
...
<head>
    ...
    <title>403 — غير مصرح بالوصول | Veyra ERP</title>
    <x-site-favicon />
    @vite(['resources/css/app.css'])
</head>
<body class="relative min-h-screen overflow-x-hidden bg-ink-900 px-4 py-10 font-sans text-mist-300 antialiased sm:py-14">
    ...
    <div class="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-2xl flex-col items-center justify-center py-6 sm:min-h-[calc(100vh-7rem)]">
        ...
        <div class="relative mx-auto flex h-[14rem] w-[14rem] max-w-full shrink-0 items-center justify-center sm:h-[18rem] sm:w-[18rem]">
            <div class="absolute h-[11rem] w-[11rem] rounded-full bg-emerald-400/20 blur-3xl sm:h-[14rem] sm:w-[14rem]"></div>

            <div class="relative flex h-full w-full items-center justify-center rounded-[40px] bg-ink-700/60 p-6 shadow-2xl backdrop-blur-md sm:p-8">
                    ...
                    <div class="flex h-full w-full flex-col overflow-hidden rounded-3xl border border-ink-600 bg-ink-900">
                        ...
                        <div class="flex flex-1 flex-col items-center justify-center gap-4 px-6">
                            ...
                            <div class="text-center">
                                <p class="font-display text-xs font-bold uppercase tracking-[0.2em] text-emerald-400">Access Denied</p>
        ...
        {{-- "403" digit pill --}}
        <span class="relative z-10 -mt-6 inline-flex shrink-0 items-center justify-center rounded-full border border-mist-700 bg-ink-700 px-5 py-1.5 shadow-xl">
