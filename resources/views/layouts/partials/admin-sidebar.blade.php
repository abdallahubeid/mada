        ...
        [
            ...
            'items' => [
                [
                    ...
                    'children' => [
                        ['label' => 'المشاكل', 'route' => 'admin.problems.index', 'pattern' => 'admin.problems*'],
                        ['label' => 'الحلول', 'route' => 'admin.solutions.index', 'pattern' => 'admin.solutions*'],
                        ['label' => 'ما نقدمه', 'route' => 'admin.offerings.index', 'pattern' => 'admin.offerings*'],
                        ['label' => 'الموديولات', 'route' => 'admin.modules.index', 'pattern' => 'admin.modules*'],
                        ['label' => 'ميزات الذكاء الاصطناعي', 'route' => 'admin.ai-features.index', 'pattern' => 'admin.ai-features*'],
                        ['label' => 'الميزات العامة', 'route' => 'admin.features.index', 'pattern' => 'admin.features*'],
                        ['label' => 'آراء العملاء', 'route' => 'admin.testimonials.index', 'pattern' => 'admin.testimonials*'],
                        ['label' => 'إعدادات الصفحة الرئيسية', 'route' => 'admin.landing.settings.edit', 'pattern' => 'admin.landing.settings*'],
                    ],
                ],
            ],
        ],
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'children' => [
                        ['label' => 'المشتركين', 'route' => 'admin.newsletter.index', 'pattern' => 'admin.newsletter.index'],
                        ['label' => 'الحملات البريدية', 'route' => 'admin.newsletter.campaigns.index', 'pattern' => 'admin.newsletter.campaigns.*'],
                    ],
                ],
            ],
        ],
