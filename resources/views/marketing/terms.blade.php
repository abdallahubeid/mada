...
<x-layouts.marketing
    title="الشروط والأحكام — مدى"
    description="شروط استخدام منصة مدى: الحسابات، المستأجرين، الخطط، والاستخدام المقبول."
>
    <x-marketing.nav />
    ...
    <main>
        <x-marketing.page-hero
            ...
            subtitle="آخر تحديث: يوليو 2026. باستخدامك لـ مدى فإنك توافق على هذه الشروط."
        />
        ...
        <section class="bg-white py-24 dark:bg-ink-900">
            <article class="mx-auto max-w-3xl space-y-10 px-4 text-sm leading-relaxed text-mist-600 sm:px-6 lg:px-8 dark:text-mist-300">
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">1. قبول الشروط</h2>
                ...
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">2. الحسابات والمستأجرون</h2>
                ...
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">3. الخطط والتجربة</h2>
                ...
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">4. الاستخدام المقبول</h2>
                ...
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">5. الملكية الفكرية</h2>
                    <p class="mt-3">المنصّة وعلاماتها وتصميمها ملك لـ مدى. تبقى بياناتك التشغيلية ملكاً لمؤسستك. نمنحك ترخيصاً محدوداً غير حصري لاستخدام الخدمة وفق خطتك.</p>
                </div>

                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">6. إخلاء المسؤولية</h2>
                ...
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">7. إنهاء الخدمة</h2>
                ...
                <div>
                    <h2 class="font-display text-xl font-medium text-ink-900 dark:text-ink-50">8. التواصل</h2>
                    <p class="mt-3">للاستفسارات القانونية أو التعاقدية: <a href="{{ route('marketing.contact') }}" class="font-medium text-brand-600 hover:underline dark:text-brand-300">تواصل معنا</a>.</p>
                </div>
            </article>
        </section>
    </main>
