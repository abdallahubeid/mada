...
test('setting seeder persists footer and social content', function () {
    ...
    expect(Setting::getValue('footer_description'))->toBe('نظام إدارة الموارد المؤسسي الذكي الذي يواكب طموحات مؤسستك القادمة.')
...
test('marketing content footer reads settings keys', function () {
    ...
    expect($footer['blurb'])->toBe('نظام إدارة الموارد المؤسسي الذكي الذي يواكب طموحات مؤسستك القادمة.')
...
test('landing page footer renders seeded cms content', function () {
    ...
    $this->get(route('landing'))
        ->assertOk()
        ->assertSee('نظام إدارة الموارد المؤسسي الذكي الذي يواكب طموحات مؤسستك القادمة.', false)
